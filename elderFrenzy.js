...
ElderFrenzyBank.launch = function(){
	...
	CCSE.AppendStatsGeneral('<div class="listing"><b>Conjure Baked Goods + current (de)buffs :</b> '+Beautify(Math.min(Game.cookiesPs * 60 * 30, Game.cookies * 0.15))+'</div>');
        CCSE.AppendStatsGeneral('<div class="listing"><b>Elder Frenzy + Conjure Baked Goods :</b> '+Beautify(Math.min(Game.cookiesPsRaw * 60 * 30 * 777, Game.cookies * 0.15))+'</div>');	    
        CCSE.AppendStatsGeneral('<div class="listing"><b>Elder Frenzy + Conjure Baked Goods at max bank :</b> '+Beautify(Game.cookiesPsRaw * 60 * 30 * 777)+'</div>');
